...
set CYGWIN_PACKAGES=autoconf,automake,bash-completion,bc,curl,diffutils,expect,gcc-core,gettext,git,git-completion,git-svn,glib2.0-openssl,gnupg,inetutils,libiconv,libncursesw-devel,lz4,make,mc,nc,neovim,openssh,openssl,perl,psmisc,python36,python36-cffi,python36-devel,python36-cryptography,python36-openssl,python36-pip,python36-devel,python36-cryptography,python36-openssl,pv,readline,rsync,ssh-pageant,screen,subversion,unzip,vim,wget,zip,zlib-devel,zstd
